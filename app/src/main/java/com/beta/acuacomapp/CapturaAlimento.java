...
public class CapturaAlimento extends AppCompatActivity implements View.OnClickListener {
    ...
    String HttpUrl = "http://10.0.1.101/member/insertar_alimento.php";
  ...
  //  String[] alimento_ID = getResources().getStringArray(R.array.alimento_ID);
    ...
    private void getVolleyZonas(){
        ...
        URLline = "http://10.0.1.101/member/get_zonas.php?granjas="+GranjaId;
    ...
    private void getVolleyEstanques(){
        ...
        URLline = "http://10.0.1.101/member/get_estanque.php?zonas="+dataZona;
    ...
    private void getVolleyAlimentos(){
        ...
        URLline = "http://10.0.1.101/member/get_alimento.php";
    ...
    private void getVolleyTipos(){
        ...
        URLline = "http://10.0.1.101/member/get_tipos.php";
